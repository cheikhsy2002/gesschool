...
<head>
    ...
    <link rel="stylesheet" href="../../Style/Classe/addCL.css">
...
<body>	
    <div class="container col-md-6 col-md-offset-3" style="margin-top: -350px;;">
            <div class="panel panel-info">
                <div class="panel panel-heading"><h2 style="color: white;">Modif Classe</h2></div>
                <div class="panel-body" style="background: silver;">
                    <form action="Controller/classe.php" method="POST">
                        <div class="form-group">
                            <label class="control-label" >Libelle</label>
                            <input type="text" value="<?php echo $link[0];?>" required="required" readonly="readonly" class="form-control" name="libelle">
                        </div>
                        <div class="form-group">
                            <label class="control-label" >Niveau</label>
                            <input type="text"  value="<?php echo $link[1];?>" required="required" class="form-control" name="niveau">
                        </div>
                        <div class="form-group">
                            <label class="control-label" >Filiere</label>
                            <input type="text"  value="<?php echo $link[2];?>" required="required" class="form-control" name="filiere">
                        </div>
                        <p>&nbsp;</p>
